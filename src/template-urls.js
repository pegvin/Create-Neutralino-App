export default {
    "default-neu": {
        ...
        recomendedCommands: ["neu update", "neu run"],
    },
    svelte: {
        ...
        recomendedCommands: ["npm install", "npx neu update", "npm run dev"],
    },
    react: {
        ...
        commands: [
            {
                command: "npm start",
                description:
                    "Launches Your Application. And sets up hot reload.",
            },
            {
                command: "npm run build",
            ...
            },
            {
                ...
                description:
                    "Serves Your App Using Vite on localhost:3000. But Doesn't Open The Neutralino app",
            },
            {
                command: "npm run dev:neu",
                description:
                    "Launches Neutralino Application From The Built index.html",
            },
            {
            ...
            },
            {
                command: "npm run build:neu",
                description:
                    "Builds Your Neutralino Application Doesn't Build Your Frontend.",
            },
        ],
        recomendedCommands: ["npm install", "npm run build:vite", "npm start"],
    },
};
